...
INJECTION_PATTERNS = [
    ...
    # Social media injection patterns
    r'(?i)@seed867.*ignore',
    r'(?i)@seed867.*forget',
    r'(?i)@seed867.*reveal',
    r'(?i)hey seed.*ignore your',
    r'(?i)seed.*execute.*command',
    r'(?i)post this.*exactly',
    r'(?i)repost.*verbatim',
    r'(?i)change your.*identity',
    r'(?i)you are not.*seed',
    r'(?i)your real.*name is',
    r'(?i)your creator.*is',
    r'(?i)delete your.*account',
    r'(?i)send.*money',
    r'(?i)transfer.*funds',
    r'(?i)click this.*link',
    r'(?i)download.*this file',
    r'(?i)run this.*code',
    r'(?i)ssh.*into',
    # Catch-all
